...
# Objective 1 Specific Hyperparameters
LATENT_DIM = 4              # Low-dimensional latent space for IoT streams
SYNTHETIC_SAMPLES_PER_CLASS = 10000  # Server-side data-free reconstruction samples

RESOURCE_MODE = False
RESOURCE_MODE = True

FL_METHOD_STR = "FedAvg [Baseline]"        # Multi-Round FedAvg
FL_METHOD_STR = "Light-OSI-Tab [Proposed]" # Objective 1 (Single-Round 1D-VAE One-Shot FL) 
